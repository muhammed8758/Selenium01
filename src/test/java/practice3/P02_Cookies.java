...
public class P02_Cookies extends TestBase {
    ...
    public void cookiesTest() {
        ...
        Cookie myCookie = new Cookie("myCookie", "123456");// yeni coookie ekleme objesi
        driver.manage().addCookie(myCookie); // bu da emri

        //Yeni cookie eklendikten sonra cookie sayısını ve isimlerini yazdırınız
        Set<Cookie> cookies2 = driver.manage().getCookies();
        System.out.println(cookies2.size());

        for(Cookie c2 : cookies2) {
        ...
        System.out.println("cookies3 = " + cookies3);
