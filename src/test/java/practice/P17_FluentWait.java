...
public class P17_FluentWait extends TestBase {
    @Test
     ...
     */
       ...
       waitButton.click();
        FluentWait<WebDriver> wait = new FluentWait<>(driver)
                .withTimeout(Duration.ofSeconds(20)).//MAxiumum Bekleme Suresi
                pollingEvery(Duration.ofSeconds(2));// HAngi sikliklarla tekrarlamasi gerektigini belirtiriz
        wait.until(ExpectedConditions.alertIsPresent()); //alert cikana bekle
